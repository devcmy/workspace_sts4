...
public class JavaScriptAjaxRestController {
	...
	@RequestMapping("/03.ajaxRequestGETPOST")
	...
	@RequestMapping("/04.server_clock")
	public String server_clock() {
		return new Date().toLocaleString();
	}

	@RequestMapping(value="/05.newsTitlesHTML", produces = "text/html;charset=UTF-8")
