...
<ul>
	...
	<li>SPEL(SCOPE객체에 등록된 숫자변수(속성이름)):
		<s:eval expression="price0+price1/9*8"/>
	</li>
	...
	<li>
		...
		<s:eval expression="new java.text.DecimalFormat('###,###.0').format(price1)"></s:eval>
		<br>
		
	</li>
	<li>
		@를 이용해서 SpringContainer에 등록된 빈사용가능 <!-- 등록된 BEAN의 ID를 통해 사용 가능 -->
